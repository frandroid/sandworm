...
describe FormatsController do
  ...
  # FormatsController. Be sure to keep this updated too.
  def valid_session
    {}
  end
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved format as @format" do
        ...
        post :create, {:format => {}}, valid_session
        assigns(:format).should be_a_new(Format)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested format" do
        format = Format.create! valid_attributes
        # Assuming there are no other formats in the database, this
        # specifies that the Format created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Format.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, {:id => format.to_param, :format => {'these' => 'params'}}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the format as @format" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Format.any_instance.stub(:save).and_return(false)
        put :update, {:id => format.to_param, :format => {}}, valid_session
        assigns(:format).should eq(format)
      end
